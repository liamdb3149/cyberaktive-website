...
export default function PropertyHero() {
  return (
    <section className="pt-20 lg:pt-24 pb-20 lg:pb-32 section-mesh min-h-screen flex items-center relative overflow-hidden">
      {/* Floating Elements */}
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        <RevealOnScroll>
          <div className="max-w-6xl mx-auto text-center">
            ...
            <h1 className="premium-text-4xl md:text-6xl lg:text-7xl mb-8 text-glow">
              <span className="text-foreground block mb-2">Property Management</span>
              <span className="gradient-text block mb-2 font-black">AI Automation</span>
              <span className="text-foreground block">That Actually Works</span>
            </h1>
            
            <RevealOnScroll delay={300}>
              <p className="premium-text-xl lg:text-2xl text-muted-foreground mb-4 max-w-4xl mx-auto font-medium">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
                ...
                <CalendarModal>
                  <Button 
                    size="lg" 
                    variant="outline"
                    className="glass-card border-2 text-foreground hover:bg-glass-bg font-semibold text-lg px-12 py-6 rounded-2xl hover:scale-105 transition-all duration-300"
