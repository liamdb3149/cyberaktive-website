...
import { ArrowRight, CheckCircle, TrendingUp, Clock, Calendar, Mail, AlertCircle } from "lucide-react";
...
import { getLegalServicePage } from "@/data/legalServicePages";
...
export default function LegalServicePage() {
  const { practiceArea, service } = useParams<{ practiceArea: string; service: string }>();
  const page = getLegalServicePage(practiceArea, service);
  ...
  useEffect(() => {
    ...
    const canonicalHref = `https://cyberaktive.com/legal/${page.practiceArea}/${page.service}`;
        ...
        <section className="bg-[#050d1a] pt-6 pb-20">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 mb-10">
            <nav className="text-sm flex items-center gap-2 flex-wrap" aria-label="Breadcrumb">
              ...
              <span className="text-gray-600">/</span>
              <Link href={`/legal/${page.practiceArea}`} className="text-blue-400 hover:text-blue-300 transition-colors capitalize">
                {page.practiceAreaName}
              </Link>
              <span className="text-gray-600">/</span>
              <span className="text-gray-300">{page.serviceName}</span>
            </nav>
          </div>
            ...
            <RevealOnScroll>
              <div className="max-w-2xl mb-12">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                  Why {page.practiceAreaName} Firms Need This Now
                </h2>
                <p className="text-gray-500">
                  The workflows you're doing manually today have a direct cost. Here's what's actually bleeding revenue from your practice.
                </p>
              </div>
            </RevealOnScroll>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <RevealOnScroll>
              <div className="max-w-2xl mb-12">
                ...
                <p className="text-gray-500">
                  From kickoff to working automation - here's exactly what happens.
                </p>
              </div>
            </RevealOnScroll>
                  ...
                  <div className="flex items-start gap-5 p-6 bg-white rounded-xl border border-gray-100 hover:border-blue-100 hover:shadow-md transition-all duration-200 group">
                    <div className="flex-shrink-0 flex flex-col items-center">
                      ...
                      {i < page.howItWorks.length - 1 && (
                        <div className="w-px h-4 bg-blue-200 mt-2" />
                      )}
                    </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <RevealOnScroll>
              <div className="max-w-2xl mb-12">
                ...
                <p className="text-gray-400">Measurable outcomes your firm will feel from day one.</p>
              </div>
            </RevealOnScroll>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl">
              {page.results.map((result, i) => (
                <RevealOnScroll key={i} delay={i * 80}>
                  <div className="flex items-start gap-4 p-5 bg-white/5 rounded-xl border border-white/10 hover:border-emerald-500/30 hover:bg-white/8 transition-all duration-200 group">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                  <div>
                    <h2 className="text-3xl md:text-4xl font-bold text-white mb-6 leading-tight">
                      Ready to Automate Your {page.practiceAreaName} Practice?
                    </h2>
                    <ul className="space-y-4">
                      {[
                        "We review your current intake process",
                        "Identify your highest-ROI automation",
                        "Clear implementation timeline and cost - upfront",
                      ].map((item, i) => (
